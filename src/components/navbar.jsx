        ...
        <div className='h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl'>
           ...
           {/* Logo */}
            ...
            <div className='md:hidden'>
                ...
                {/* MENU LIST  */}
                {open && (                
                    <motion.div variants={listVariants} inital="closed" animate="opened" className='absolute top-0 left-0 w-screen h-screen bg-black text-white flex flex-col items-center justify-center gap-8 text-4xl'>
                        {links.map( link => (
